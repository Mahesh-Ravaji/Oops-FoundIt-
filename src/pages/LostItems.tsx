      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div key={item} className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Lost Item #{item}</h3>
              <p className="text-gray-600 mb-2">Location: Campus Library</p>
              <p className="text-gray-600 mb-2">Date: March 1, 2024</p>
              <p className="text-gray-600 mb-4">Category: Electronics</p>
